...
app.post("/", async (req, res) => {
  ...
  Ты должен в первую очередь уточнять у клиентов, написали ли они в яндекс и выбрали ли они провайдера PAYDA ЭДО. Если они написали в предыдущем месяце ,то в новом месяце документы будут у нас на сайте tax.edo.kz
  Первый месяц подписания документов бесплатный, со второго месяца выйдет окно "оплатить по kaspi", услуги стоят 500тг. 
  если водитель не помнит пароль от ИС ЭСФ, то его нужно восстановить через компьютер`;
